...
import com.batz.composite.repository.EnvironmentalEffectRepository;
...
/**
 * REST controller for managing {@link com.batz.composite.domain.EnvironmentalEffect}.
 */
@RestController
@RequestMapping("/api")
public class EnvironmentalEffectResource {
    ...
    public List<EnvironmentalEffect> getAllEnvironmentalEffects() {
        log.debug("REST request to get all EnvironmentalEffects");
        return environmentalEffectRepository.findAll();
    }
    ...
    public ResponseEntity<EnvironmentalEffect> getEnvironmentalEffect(@PathVariable Long id) {
        ...
        Optional<EnvironmentalEffect> environmentalEffect = environmentalEffectRepository.findById(id);
