...
/**
 * REST controller for managing {@link com.batz.composite.domain.WeightingFactor}.
 */
@RestController
@RequestMapping("/api")
public class WeightingFactorResource {
    ...
    public List<WeightingFactor> getAllWeightingFactors(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
        log.debug("REST request to get all WeightingFactors");
        return weightingFactorRepository.findAllWithEagerRelationships();
    }
    ...
    public ResponseEntity<WeightingFactor> getWeightingFactor(@PathVariable Long id) {
        ...
        Optional<WeightingFactor> weightingFactor = weightingFactorRepository.findOneWithEagerRelationships(id);
