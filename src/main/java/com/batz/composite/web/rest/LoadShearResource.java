...
/**
 * REST controller for managing {@link com.batz.composite.domain.LoadShear}.
 */
@RestController
@RequestMapping("/api")
public class LoadShearResource {
    ...
    public List<LoadShear> getAllLoadShears() {
        log.debug("REST request to get all LoadShears");
        return loadShearRepository.findAll();
    }
    ...
    public ResponseEntity<LoadShear> getLoadShear(@PathVariable Long id) {
        ...
        Optional<LoadShear> loadShear = loadShearRepository.findById(id);
